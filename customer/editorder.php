...
<div class="container">
    <h1><center>Welcome to bonAppetit</center></h1>
                ...
                while ($item = $res->fetch_assoc()) {
                    ...
                    <tr>
                        <form action="waiter.php" method="post">
                            <input name="itemid" type="number" value="<?= $item['id'] ?>" readonly required
                                   style="visibility:hidden;">
                            <input name="orderid" type="number" value="<?= $_GET['orderid'] ?>" readonly required
                                   style="visibility:hidden;">
                            <td> <?= $item['itemname'] ?> </td>
                            <td> <?= $item['price'] ?> </td>
                         ...
                         <!--   <td><input type=text name=remarks></td> -->
                            <td>
                                <button type="submit" class="btn btn-warning " name="add">Add item</button>
                            </td>
                        </form>
                    </tr>
                <?php } ?>
