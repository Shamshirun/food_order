...
if (isset($_POST) && !empty($_POST)) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $msg = "alert('{$code} FAILED. Please try again')" . $conn->error;
    }
            ...
            <div class="row">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="percent" placeholder="Enter Discount Percent" type="number"
                               min=0 max=100 required>
                    </div>
                    <div class="form-group">
                        <label for="minprice">Enter Discount Min Price:</label>
                        <input class="form-control" name="minprice" placeholder="Enter min price" type="number"
                               required>
                    </div>
