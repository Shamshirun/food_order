    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="manageitems.php">Manage Food Items<span class="sr-only">(current)</span></a>
                </li>
            ...
            <div class="row">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="itemname" placeholder="Butter Chicken"
